async function THQPlus() {
   ...
   const lookup = {
            ...
            cog: {
               ...
               'BOTTOM FEEDER':           ["Bottom Feeder","B",1,4],
               'BLOODUSCKER':             ["Blood Sucker","B",2,7],
               'DOUBLE TALKER':           ["Dbl Talker","B",3,5],
               'AMBULANCE CHASER':        ["Amb Chaser","B",4,8],
               'BACK STABBER':            ["Back Stabber","B",5,"10G"],
               'SPIN DOCTOR':             ["Spin Doctor","B",6,10],
               'LEGAL EAGLE':             ["Legal Eagle","B",7,14],
               'BIG WIG':                 ["Big Wig","B",8,"15G"],
               'SHORT CHANGE':            ["Short Change","B",1,4],
               'PENNY PINCHER':           ["Penny Pincher","B",2,5],
               'TIGHTWAD':                ["Tightwad","B",3,6],
               'BEAN COUNTER':            ["Bean Counter","B",4,9],
               'NUMBER CRUNCHER':         ["Numb Cruncher","B",5,9],
               ...
               'TWO-FACE':                ["Two-Face","B",6,12],
               'THE MINGLER':             ["Mingler","B",7,"13G"],
               'MR. HOLLYWOOD':           ["Mr Hollywood","B",8,"15G"],
